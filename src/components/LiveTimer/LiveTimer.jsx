...
//       <h1 className="text-3xl sm:text-3xl md:text-5xl font-bold mb-2">
//         Weekly Deals
//       </h1>

//       <p className="text-gray-600 text-xs sm:text-sm mb-5 max-w-sm">
...
//           <div
//             key={index}
//             className="bg-gray-50 shadow-lg rounded-md p-3 text-center"
//           >
...
//         padding="px-6 py-2"
//         onClick={() => console.log('Shop button clicked')}
//       />
//     </div>
//   );
// }
